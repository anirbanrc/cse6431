 ...
 */
public class FriesMachine implements Machine
{
    ...
    public synchronized void setOccupancy(boolean occ)
    {
        occupied_ = occ;
    }
    ...
    public synchronized int startCooking(int number,int startTime,int cid)
    {
        ...
        try {
			Thread.sleep(300*number);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
        this.setEndTime(startTime+number*3);
